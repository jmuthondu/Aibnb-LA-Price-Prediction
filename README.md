...
A more accurate version could be built using data on the actual average nightly rates paid e.g from sites like [AirDNA](https://www.airdna.co/) that sell higher quality Airbnb data.
